        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              <h1 className={classes.title}>اسم المَفْول</h1>
              ...
              <p>
                <ContrastWord inRu> مَكْتُوب </ContrastWord> - это предмет на которое падает
                действие <ContrastWord inRu> كَتَبَ </ContrastWord>, то есть это письмо, запись, это
                то что написано
              </p>
              ...
              <h3 className={classes.title}>1 шаблон</h3>
              ...
              <h3 className={classes.title}>2 шаблон</h3>
