        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <h2 className="title">Активный залог ✍️ </h2>
              <div className="desc">
              ...
              <h2 className="title">Пример пассивного залога فُعِلَ - يُفْعَلُ ✍️ </h2>
              ...
              <h2 className="title">Пассивный залог со средней больной ✍️ </h2>
              ...
              <h2 className="title">Пассивный залог с последней больной ✍️ </h2>
              <div className="arsent">
                <div className="arsent__original">
