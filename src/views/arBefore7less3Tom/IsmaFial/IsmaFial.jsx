        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <h2 className="title">اسم الفاعِل у глаголов с шаддой ✍️ </h2>
              <div className="desc">
              ...
              <h2 className="title">اسم الفاعِل у глаголов со средней слабой ✍️ </h2>
              ...
              {/* -------- */}
              <h2 className="title">اسم الفاعِل у глаголов со слабой последней ✍️ </h2>
              ...
              {/* -------- */}
              <h2 className="title">С точки зрения сарф и нахв ✍️ </h2>
              <div className="desc">
