...
function MaAttama() {
  return (
    <>
      <h2 className="title h2ar">ما النَّكِرة التَّامة المبهَمةُ</h2>

      <div className="desc">
        <span className="desc__ar"> ما </span> обсолютной неопределённости и не ясности. Приходит как описание к определению к предыдущему
        определяемому слову
      </div>
