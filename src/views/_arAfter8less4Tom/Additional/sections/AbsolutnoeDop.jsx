...
export default function() {
  return (
    <>
      ...
      <div className="desc">
        <b> Абсолютное дополнение </b> (المفعول المطلق) упоминается масдаром в после глагола и состоит обычно из тех же букв что и глагол.
        Приходит
        <b> для усиления </b> или <b> указания на количество </b> или <b> разъяснения типа действия </b>, а иногда приходит как заменитель
        глагола. Называется так, потому что не обусловлено предлогом как другие.
      </div>
      ...
      <div className="desc">
        Иногда хлебное место Масдара заменяет то, что указывает на него и то что заменило Масдар будет принимать винительный падеж <br />
      </div>
      ...
      <div className="items">
        <div className="item">
          ...
          <div className="arsent">
            ...
            <div className="arsent__translate">
              Взыскал с меня директор некоторым взысканием (بَعضَ заняло хлебное место Масдара и принимает теперь его квоты (винительный
              падеж) )
            </div>
          </div>
          <div className="arsent">
            ...
            <div className="arsent__translate">Каким сном ты спишь? (أيَّ заняло хлебное место Масдара и приняло винительный падеж) </div>
          </div>
        </div>
        <div className="item">
      ...
      <div className="arsent arsent_rule">
        ...
        <div className="arsent__translate">
          <span className="contrast_2"> Прибытие благословенное </span>, (где подразумевается) <span className="contrast"> ты прибыл </span>
      ...
      <div className="arsent">
        ...
        <div className="arsent__translate">
          Иногда Аллахъ объединяет две противоположные вещи, после того как думали думающие всяким раздумьем что эти две противоположности
          не встретятся
        </div>
      </div>
    </>
