        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              <h1 className="title"> Виды дополнений (المفعول) 🌴</h1>
              <div className="desc">
              ...
              <h2 className="title h2ar"> المَفعول بِه ✍️ </h2>
              <div className="desc">
              ...
              <h2 className="h2ar title">المفعول مَعَهُ ✍️ </h2>
              <div className="desc">
