          ...
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <div className="desc">
                ...
                <b className="desc__ar"> الْاِسْمُ الَّذِي لَا يَنْصَرِفُ </b>.
                Они отличаются тем, что в неопределённом состоянии{' '}
                <b> не принимают нунации </b> (тан-вин может появиться только
                при необходимости для гладкости слога, например:
                <b className="desc__ar"> سَلَاسَلاً وَ أَغْلَالاً</b> )
                <b>
                  {' '}
                  и различают только два падежа: именительный и винительный.
                </b>
              </div>
              <div className="desc">
                Имена становятся двухпадежным, если содержат в себе две причины
                (точнее, два изъяна) или одну, которая имеет силу двух причин.
                Одна причина связана с внешней звуковой оболочкой слова, а
                вторая с её смыслом. Для лёгкости запоминания причин
                двухпадежности обычно используется вспомогательная связка:
              </div>
              <div className="arsent">
                <div className="arsent__original">
                  عَدْلٌ ووَصْفٌ وَتَأْنِيثٌ وَمَعْرِفَةٌ وَعُجْمَةٌ ثُمَّ
                  جَمْعٌ ثُمَّ تَرْكِيبٌ وَالنُّونُ الزَائِدَةُ مِنْ قَبْلِهَا
              ...
              <div className="arsent">
                <div className="arsent__original">
                  مَدَارِسُ فَاطِمَةُ رَمَضَانُ
                </div>
                <div className="arsent__translate">
                  Именительный падеж{' '}
                  <span className="desc__ar"> (الرَّفْعُ) </span>
                </div>
              </div>
              <div className="arsent">
                <div className="arsent__original">
                  مَدَارِسَ فَاطِمَةَ رَمَضَانَ
                </div>
                <div className="arsent__translate">
                  Родительный падеж{' '}
                  <span className="desc__ar"> (الجَرُّ) </span>
                </div>
              </div>
              <div className="arsent">
                <div className="arsent__original">
                ...
                <div className="arsent__translate">
                  Винительный падеж{' '}
                  <span className="desc__ar"> (النَّصْبُ) </span>
                </div>
              </div>
              ...
              <div className="desc">
                ...
                <b className="desc__ar"> (ى) </b> достаточно, чтобы сделать имя
                двухпадежным&nbsp;
              ...
              <div className="desc">
                <b> Множественное множественного числа </b> (предельное
                множественное) так же обладает двойной силой
              </div>
              ...
              <div className="desc">
                ...
                <b className="desc__ar"> التاء المَرْبُوطَة </b>, так и не
                имеющие. Если женское имя трёхбуквенное, а средняя с "сукуном",
              ...
              <div className="desc">
                ...
                "сукуном", то оно относится к трёхпадежным, кроме случаев если
                же оно женского рода, тогда танвин никогда не добавляется.
              </div>
              <div className="arsent">
                <div>
              ...
              <div className="desc">
                Образованные из прилагательных путём изменения их формы по
                модели <b className="desc__ar"> فُعَلُ </b>
              </div>
              <div className="arsent">
                <div>
              ...
              <div className="desc">
                (А у прилагательных в этой модели فَعْلانُ женский род
                образуется по модели فَعْلَى )
              </div>
              <div className="arsent">
                <div>
              ...
              <h3 className="title">
                Имена, образованные из двух слов путём слитного (но не
                изафетного) соединения.
              </h3>
              <div className="desc">
