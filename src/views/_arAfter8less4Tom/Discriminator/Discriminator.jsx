        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <div className="desc">
                <b> Различитель предмета </b> используется
                <b> указания измеренного вещества </b>
                после названий меры, веса, длины и числительных. Его иногда называют название у него <i> различитель одного слова</i>
              </div>
