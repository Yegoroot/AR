...
class Page extends React.Component {
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>Для различения предмета рассмотрения из общего смысла используется التمييز (различитель) </title>
          <meta
            name="description"
            content="Различитель содержит смысл مِن (из) для того, чтоб разъяснить, объяснить то, что пришло из общего смысла, различитель конкретизатор. Имеется разделитель предмета, и разделитель отношений"
          />
        </Helmet>
        <Header
          color="transparent"
