        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <p>
                <b>Лицо деятель</b> можно перевести как "действительное причастие" это имя существительное указывает на
                того кто выполняет действие и образуется от 3ёх буквенного глагола по шаблону{' '}
              ...
              <p>
                Не смотря на то что حَاجٌَ и ему подобные не похожи на اسم الفاعِل, мы чётко видим по каким принципам
                образуется это лицо деятель
              </p>
              <ArSent>
                حجّ - حَجْجَ - حاجِج ={' '}
              ...
              <ArSent>
                <div>
                  <span>هَدى</span> -
                  <ContrastWord inRu translate="(не определенный) руководитель" red>
                    هادٍ
                  </ContrastWord>
                  -
                  <ContrastWord inRu translate="(конкретный) руководитель" red>
                    الهادِي
                  </ContrastWord>
                </div>
              </ArSent>
              <ArSent>
                <div>
                  <span>بَنَى</span>-
                  <ContrastWord inRu translate="(не определенный) строитель" red>
                    بانٍ
                  </ContrastWord>
                  -
                  <ContrastWord inRu translate="(конкретный) строитель" red>
                    البانِي
                  </ContrastWord>
                </div>
              </ArSent>
              ...
              <p>
                На картинке показаны подходы с точки зрения сарфа и нахв, три разных предложения и три разных роли у
                одного слова
              </p>
