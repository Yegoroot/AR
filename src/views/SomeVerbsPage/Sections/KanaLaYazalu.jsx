            ...
            <div className="wrap1">
              ...
              <GridContainer>
                <GridItem xs={12} sm={6}>
                  ...
                  <ArSent translate="Хамид сейчас болен">حامد مرِيض الأنَ</ArSent>
                  <ArSent
                    translate={
                      <div>
                ...
                <GridItem xs={12} sm={6}>
                  ...
                  <ArSent translate="Ибрахим спит">إبرهيم نائِم</ArSent>
                  <ArSent
                    translate={
                      <div>
              ...
              <p>
                Глагол كان не является полноценным глаголом (предложение остаётся именным), но из за
                его внешних сходств, предложение похоже на глагольное, а происходит следующее{" "}
              </p>
