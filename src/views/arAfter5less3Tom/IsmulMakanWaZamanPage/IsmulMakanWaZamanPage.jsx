          ...
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <p className="desc">
                ...
                присоединяется
                <span className="desc__ar"> ة </span> и некоторые ученые говорят что эта та-марбута
                указывает на постоянство действия
              ...
              <AnimateCard>
                <div className="arsent arsent_rule">
                  ...
                  <div className="arsent__translate">
                    ...
                    времени, <span className="contrast"> "имя места" </span> если служит для
                    указания места
                  </div>
                </div>
              </AnimateCard>
              <AnimateCard>
                <div className="arsent arsent_rule">
                  <div className="arsent__original">
                    اِسما الزمانِ و المكانِ اسْمانِ مَصُوغَانِ للدَّﻻلة على زمانِ الفِعْلِ أو
                    مكانِه. و يُصاغانِ من الفعل الثلاثِيَّ المُجَرَّدِ على وزن
                    <span className="contrast"> مَفْعَلٍ </span> و
                    <span className="contrast"> مَفْعِلٍ </span>
                  </div>
                  <div className="arsent__translate">
                    "Имена места и времени" образованы (отлиты) для указания время действия или
                    места действия. И они образуются от трехбуквенного первообразного глагола
                    (который не содержит служебных букв) по моделям
                    <span className="contrast"> مَفْعَلٍ </span> و
                    <span className="contrast"> مَفْعِلٍ </span>
                  </div>
                </div>
