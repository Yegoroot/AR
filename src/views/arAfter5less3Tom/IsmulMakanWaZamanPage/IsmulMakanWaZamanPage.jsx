        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              <h1 className="title">
                Имена места и времени (اسم&nbsp;مكان&nbsp;و&nbsp;زمان)&nbsp;
                <span className="ph">§</span>
              </h1>

              <p className="desc">
                <b>Имена места и времени</b>. В грамматическом правиле для
                примера возьмем слово
                <span className="desc__ar"> مَوْعِد </span>. Иногда к именам
                места и времени присоединяется
                <span className="desc__ar"> ة </span> и некоторые ученые говорят
                что эта та-марбута указывает на постоянство действия
              ...
              <AnimateCard>
                <div className="arsent arsent_rule">
                  <div className="arsent__original">
                    كَلِمة <span className="contrast_2"> مَوْعِد </span>{' '}
                    مأْخُوذَة من
                    <span className="contrast_2"> وَعَدَ يَعِدُ </span>{' '}
                    للدَّلالة على زَمانِ الوَعِْدِ, أو مَكانهِ. و تُسَمَّى{' '}
                    <span className="contrast"> اسم زمانٍ </span>
                    إذا كانت للدﻻلة على الزَّمان, و{' '}
                    <span className="contrast">اسم مَكَانٍ</span>
                  ...
                  <div className="arsent__translate">
                    ...
                    чтоб указать на Время Обещания или на его место. И
                    называется
                    <span className="contrast"> "имя времени" </span> если оно
                    служит для указания времени,{' '}
                    <span className="contrast"> "имя места" </span> если служит
                    для указания места
                  </div>
                </div>
              </AnimateCard>
              <AnimateCard>
                <div className="arsent arsent_rule">
                  <div className="arsent__original">
                    اِسما الزمانِ و المكانِ اسْمانِ مَصُوغَانِ للدَّﻻلة على
                    زمانِ الفِعْلِ أو مكانِه. و يُصاغانِ من الفعل الثلاثِيَّ
                    المُجَرَّدِ على وزن
                    <span className="contrast"> مَفْعَلٍ </span> و
                    <span className="contrast"> مَفْعِلٍ </span>
                  </div>
                  <div className="arsent__translate">
                    "Имена места и времени" образованы (отлиты) для указания
                    время действия или места действия. И они образуются от
                    трехбуквенного первообразного глагола (который не содержит
                    служебных букв) по моделям
                    <span className="contrast"> مَفْعَلٍ </span> و
                    <span className="contrast"> مَفْعِلٍ </span>
                  </div>
                </div>
              ...
              <p className="desc">
                ...
                <b> с кясрой</b> <br />
                <b> 2) </b> является глаголом <b> подобно правильным </b> с
                сильной (правильной) буквой на конце
              </p>
