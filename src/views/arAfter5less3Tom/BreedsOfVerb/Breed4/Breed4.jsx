    ...
    return (
      <div>
        <Helmet>
          <meta
            http-equiv="refresh"
            content="0; url=https://grammar.arabic.best/rules/breeds/breed-4"
          />
          <title>4 порода арабского глагола</title>
          <meta
            name="description"
            content='Глагол четвёртой породы أَفْعَلَ образуется путем добавлением хамзы в начале слова. Эта порода может делать
            глагол переходным, а может давать смысл: "вхождения"'
          />
        </Helmet>
        <Header
          color="transparent"
