    ...
    return (
      <div>
        <Helmet>
          <meta
            http-equiv="refresh"
            content="0; url=https://grammar.arabic.best/ru/rules/breeds/breed-10"
          />
          <title>10 порода арабского глагола</title>

          <meta
            name="description"
            content="Десятая порода арабского глагола اِسْتَفْعَلَ"
          />
        </Helmet>
        <Header
          color="transparent"
        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              <h1 className="title">
                Глагол десятой породы (اِسْتَفْعَلَ)&nbsp;
              ...
              <div className="arsent">
                ...
                <div className="arsent__translate">
                  {' '}
                  Готовтись к экзамену он очень близко{' '}
                </div>
              </div>
              ...
              <div className="arsent">
                ...
                <div className="arsent__translate">
                  {' '}
                  Преступник капитулировал (сдался) полицейскому{' '}
                </div>
              </div>
