        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          <div className={classes.container}>
            <div className={classes.navWrapper}>
              ...
              <p>
                Глагол страдательного залога, это действие с необозначенным лицом, бывает два
                варианта, лицо неизвестно вовсе, или из контекста понятно кто совершил
                <p>
                ...
                <p>
                  ...
                  раз, если мы добавили дополнительную информацию, а в настоящем если употребляется
                  то смысл ФАКТ, ИНСТРУКЦИЯ, ПРЕДПИСАНИЕ, ПРАВИЛО{" "}
                </p>
                <p>Пассивный залог часто встречается в новостях</p>
              </p>
              <h3 className={classes.title}>
                Пример активного залога (الفِعْل المَبْنِي لِلمَعْلُم)
              </h3>
              <p>
              ...
              <p>
                Подразумеваемое прямое дополнения مفعول به ("окна" мн.ч неразумное) повлиял на
                глагол (глагол стал женского рода). Ведь из правил мы знаем что с точки зрения
                грамматики множественное число неразумное расцениваеся как единственное число
                женского рода
              </p>
