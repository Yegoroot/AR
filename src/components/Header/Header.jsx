...
class Header extends React.Component {
    ...
    render() {
        const { classes, color, rightLinks, leftLinks, brand, isBrandAr, fixed, absolute } = this.props
        ...
        const brandClass = classNames({
            [classes.title]: true,
            [classes.isBrandAr]: isBrandAr,
        })
        const brandComponent = <Button className={brandClass}>{brand}</Button>
        return (
